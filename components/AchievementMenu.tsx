...
import { X, Trophy, Lock, Star, Gamepad2, Cat, AlertTriangle, Terminal, ShieldAlert, Clock, Crown, Search } from 'lucide-react';
              ...
              {masterAchievementsList.map((ach) => {
                ...
                return (
                  <motion.div 
                    ...
                    className={`flex items-center gap-5 p-4 rounded-xl border-2 transition-all relative overflow-hidden group ${
                      isUnlocked 
                  ...
                  >
                    ...
                    <div className={`w-14 h-14 rounded-full flex items-center justify-center shrink-0 border-2 transition-transform group-hover:scale-110 ${
                      isUnlocked ? 'bg-green-500 border-white/20 text-black shadow-[0_0_15px_rgba(34,197,94,0.3)]' : 'bg-gray-800 border-gray-700 text-gray-600'
                    }`}>
